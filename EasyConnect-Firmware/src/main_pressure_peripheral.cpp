...
// --- VERSIONE FIRMWARE PERIFERICA PRESSIONE ---
...
void setup() {
    ...
    Serial.println("\n--- EASY CONNECT PERIFERICA PRESSIONE ---");
    ...
    // OTA RS485 usa frame lunghi (hex) e può andare anche a 9600 in fallback:
    // timeout troppo basso tronca i pacchetti e corrompe l'immagine.
    Serial1.setTimeout(900);
...
void loop() {
    ...
    RS485_Peripheral_Loop(); // Chiama il gestore della comunicazione RS485.
