...
#define EXAMPLE_LCD_PIXEL_CLOCK_HZ      (DISPLAY_LOCK_PCLK_HZ) ///< Pixel clock frequency in Hz
...
#error "Display lock active: EXAMPLE_LCD_PIXEL_CLOCK_HZ must stay 30MHz"
#endif
#endif
